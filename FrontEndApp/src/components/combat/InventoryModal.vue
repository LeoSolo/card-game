  ...
  <section class="modal-backdrop" @click.self="$emit('close')">
    <div class="inventory-modal">
      ...
      <div class="inventory-section">
        ...
        <p v-else class="empty-inventory-text">Рюкзак пуст. Винтовка и энергетический щит встроены и не занимают слоты.</p>
      </div>
    </div>
  </section>
</template>
...
import type { EquippedItems, EquipmentItem, EquipmentSlot } from '@/game/equipment/equipmentTypes';
